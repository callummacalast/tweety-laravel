  ...
  <p class="text-sm mb-3">
    ...
    <div class="flex">
      ...
      <div class="flex item-center mr-4">
        <svg viewBox="0 0 20 20" class="{{ $tweet->isLikedBy(auth()->user()) ? text-blue-500 : text-gray-500 }}w-4 mr-1">
      ...
      <div class="flex item-center">
        <svg viewBox="0 0 20 20" class="{{ $tweet->isDislikedBy(Auth::user()->name) ? text-blue-500 : text-gray-500  }}w-4 mr-1">
						<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<g class="fill-current">
